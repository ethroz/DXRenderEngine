    ...
    sealed class Program
    {
        ...
        static void Main()
        {
            EngineDescription ED = new EngineDescription
            {
                ...
                OnUpdate = OnUpdate,
                UserInput = UserInput,
                WindowState = Engine.WindowState.FullScreen,
                RenderType = Engine.RenderType.RasterizedGPU,
                RayDepth = 1,
                Topology = PrimitiveTopology.TriangleList,
                ProjectionDesc = new ProjectionDescription { FOVVDegrees = 59.0f, AspectRatioWH = 16.0f / 9.0f, NearPlane = 0.01f, FarPlane = 1000.0f }
            };
